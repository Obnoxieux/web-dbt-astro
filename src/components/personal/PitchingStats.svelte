  ...
  <div class="card card-prominent stats stats-vertical md:stats-horizontal">
    <div class="stat">
      ...
      <div class="stat-value">
        {`${statsPitching.summaries.at(0)?.values.wins} - ${statsPitching.summaries.at(0)?.values.losses}`}
      </div>
    ...
    <div class="stat">
      ...
      <div class="stat-value">
        {statsPitching.summaries.at(0)?.values.innings_pitched}
      </div>
    ...
    <div class="stat">
      ...
      <div class="stat-value">
        {statsPitching.summaries.at(0)?.values.earned_runs_average}
      </div>
    ...
    <div class="stat">
      ...
      <div class="stat-value">
        {statsPitching.summaries.at(0)?.values
          .walks_and_hits_per_innings_pitched}
      </div>
